...
void create_hog_data()
{
  ...
  while(counterFolder<2)
  {

    std::string input_dir {"/home/casch/skoda/hog_converter/build/input/"+std::to_string(counterFolder)+"/"};
    //std::string input_dir {"/home/casch/skoda/hog_converter/build/input/1/"};
    std::string output_dir {"/home/casch/skoda/hog_converter/build/yolo_sonar/"+std::to_string(counterFolder)+"/"};

...
#my custom message for publishing bounding_boxes
...
def main():
    ...
    while (True):
        ...
        if signalControl:
            ...
            # print('topleft_y: {}'.format(results[0]['topleft']['y']))
            # print('topleft_x: {}'.format(results[0]['topleft']['x']))
            # print('confidence: {}'.format(results[0]['confidence']))
            # print('bottomright: {}'.format(results[0]['bottomright']))
            # print('bottomright_y: {}'.format(results[0]['bottomright']['y']))
            # print('bottomright_x: {}'.format(results[0]['bottomright']['x']))
